...
describe('Integration: Local Storage Persistence', () => {
  ...
  describe('Date Serialization', () => {
    it('should properly serialize and deserialize Date objects', () => {
      ...
      // Date should be properly restored
      expect(savedAgents[0].createdAt).toBeInstanceOf(Date);
      expect(savedAgents[0].createdAt.toISOString()).toBe('2024-01-15T10:30:00.000Z');
    });
