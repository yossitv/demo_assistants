...
function apiKnowledgeSpaceToKnowledgeSpace(apiKnowledgeSpace: ApiKnowledgeSpace): KnowledgeSpace {
  return {
    ...
    type: apiKnowledgeSpace.type,
    lastUpdatedAt: apiKnowledgeSpace.lastUpdatedAt || new Date().toISOString(),
    status: apiKnowledgeSpace.status,
    documentCount: apiKnowledgeSpace.documentCount,
    metadata: apiKnowledgeSpace.metadata,
  };
}
