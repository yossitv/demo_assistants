    ...
    <main className="min-h-screen bg-gray-50" role="main">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 space-y-6">
        <div className="flex items-center gap-3">
          <Link
            href="/knowledge"
            className="group inline-flex items-center justify-center gap-2 text-sm font-medium text-gray-700 hover:text-gray-900 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500 rounded-lg px-3 py-2 min-h-[44px]"
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
          <div className="px-6 sm:px-8 py-6 border-b border-gray-100">
            <h1 className="text-3xl font-bold text-gray-900">Create Knowledge Space</h1>
