    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-16" aria-labelledby="quick-actions-heading">
          <h2 id="quick-actions-heading" className="text-2xl font-bold text-gray-900 mb-6 text-center">
            Quick Actions
          </h2>
          <nav className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto" aria-label="Quick actions">
            ...
            <Link
              href="/knowledge"
              className="group relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8 border border-gray-200 hover:border-blue-500"
              aria-label="Navigate to knowledge spaces"
            >
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center group-hover:bg-blue-500 transition-colors">
                  <svg
            ...
            <Link
              href="/agents/create"
              className="group relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8 border border-gray-200 hover:border-purple-500"
              aria-label="Navigate to create agent"
            >
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-12 h-12 bg-purple-100 rounded-xl flex items-center justify-center group-hover:bg-purple-500 transition-colors">
                  <svg
        ...
        <section className="mb-12" aria-labelledby="agents-heading">
          <h2 id="agents-heading" className="text-2xl font-bold text-gray-900 mb-6">
          ...
          {recentAgents.length > 0 ? (
            <nav className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" aria-label="Recent agents">
              {recentAgents.map((agent, idx) => {
                ...
                <Link
                  ...
                  className="group bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 p-6 border border-gray-200 hover:border-blue-400"
            ...
            <div className="text-center py-16 bg-white rounded-xl border-2 border-dashed border-gray-300" role="status">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link
                  href="/agents/create"
                  className="inline-flex items-center justify-center px-6 py-3 min-h-[48px] border border-gray-300 text-base font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 active:bg-gray-100 transition-colors touch-manipulation"
                >
                  Create Agent
                </Link>
              </div>
        ...
        {/* Features Section */}
        <section className="mt-16 pt-12 border-t border-gray-200" aria-labelledby="features-heading">
          <h2 id="features-heading" className="sr-only">Key Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <article className="text-center">
              <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mx-auto mb-4" aria-hidden="true">
            ...
            <article className="text-center">
              <div className="w-12 h-12 bg-purple-100 rounded-xl flex items-center justify-center mx-auto mb-4" aria-hidden="true">
            ...
            <article className="text-center">
              <div className="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center mx-auto mb-4" aria-hidden="true">
