...
var AgentCreateController = /** @class */ (function () {
    function AgentCreateController(useCase, logger) {
    ...
    AgentCreateController.prototype.handle = function (event) {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        validatedBody = (0, validation_1.validateAgentCreateBody)(event.body);
                    ...
                    case 3:
                        ...
                        if (this.structuredLogger && tenantId) {
                            this.structuredLogger.logErrorWithContext('Error in AgentCreateController', error_1, {
                                requestId: requestId,
                                tenantId: tenantId,
                                userId: userId,
                                path: event.path,
                            ...
                            this.logger.error('Error in AgentCreateController', error_1, {
                                requestId: requestId,
                                path: event.path,
                                method: event.httpMethod,
                                tenantId: tenantId,
    ...
    AgentCreateController.prototype.extractAuthenticationContext = function (event) {
    ...
    AgentCreateController.prototype.logUnauthorizedAttempt = function (requestId, path) {
