...
var ChatController = /** @class */ (function () {
    function ChatController(useCase, logger) {
    ...
    ChatController.prototype.handle = function (event) {
                ...
                switch (_h.label) {
                    ...
                    case 1:
                        ...
                        this.logger.info('Chat request received', {
                            ...
                            hasSystemMessage: validatedBody.messages.some(function (m) { return m.role === 'system'; }),
                            authMethod: authMethod
                        });
                    ...
                    case 3:
                        ...
                        if (this.structuredLogger && tenantId) {
                            this.structuredLogger.logErrorWithContext('Error in ChatController', error_1, {
                                requestId: requestId,
                                tenantId: tenantId,
                                userId: userId,
                                path: event.path,
                            ...
                            this.logger.error('Error in ChatController', error_1, {
                                requestId: requestId,
                                path: event.path,
                                method: event.httpMethod,
                                tenantId: tenantId,
    ...
    ChatController.prototype.extractAuthenticationContext = function (event) {
        var _a;
    ...
    ChatController.prototype.logUnauthorizedAttempt = function (requestId, path) {
    ...
    ChatController.prototype.decodeJwtWithoutVerification = function (token) {
