...
var KnowledgeListController = /** @class */ (function () {
    function KnowledgeListController(useCase, logger) {
    ...
    KnowledgeListController.prototype.handle = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            var requestId, startTime, authContext, tenantId, userId, authMethod, result, durationMs, error_1, durationMs, tenantId, userId, authMethod;
            var _a, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.useCase.execute({ tenantId: tenantId })];
                    case 2:
                        result = _e.sent();
                    ...
                    case 3:
                        ...
                        if (this.structuredLogger && tenantId) {
                            this.structuredLogger.logErrorWithContext('Error in KnowledgeListController', error_1, {
                                requestId: requestId,
                                tenantId: tenantId,
                                userId: userId,
                                path: event.path,
                            ...
                            this.logger.error('Error in KnowledgeListController', error_1, {
                                requestId: requestId,
                                path: event.path,
                                method: event.httpMethod,
                                tenantId: tenantId,
    ...
    KnowledgeListController.prototype.extractAuthenticationContext = function (event) {
    ...
    KnowledgeListController.prototype.logUnauthorizedAttempt = function (requestId, path) {
    ...
    return KnowledgeListController;
}());
