...
var DynamoDBAgentRepository = /** @class */ (function () {
    function DynamoDBAgentRepository(dynamoDB, tableName, logger) {
        this.dynamoDB = dynamoDB;
        this.tableName = tableName;
        this.logger = logger;
    }
    DynamoDBAgentRepository.prototype.save = function (agent) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        this.logger.error('Failed to save agent to DynamoDB', error_1 instanceof Error ? error_1 : new Error(String(error_1)), {
                            tenantId: agent.tenantId,
                            agentId: agent.agentId,
                            tableName: this.tableName
                        });
    ...
    DynamoDBAgentRepository.prototype.findByTenantAndId = function (tenantId, agentId) {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_2;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.dynamoDB.send(new lib_dynamodb_1.GetCommand({
                                                TableName: this.tableName,
                                                Key: { tenantId: tenantId, agentId: agentId }
                                            }))];
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, new Agent_1.Agent(result.Item.tenantId, result.Item.agentId, result.Item.name, result.Item.knowledgeSpaceIds, result.Item.strictRAG, result.Item.description, new Date(result.Item.createdAt))];
                    case 3:
                        error_2 = _a.sent();
                        this.logger.error('Failed to find agent in DynamoDB', error_2 instanceof Error ? error_2 : new Error(String(error_2)), {
                            tenantId: tenantId,
                            agentId: agentId,
                            tableName: this.tableName
                        });
