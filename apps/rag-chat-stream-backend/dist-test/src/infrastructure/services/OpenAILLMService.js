...
var OpenAILLMService = /** @class */ (function () {
    function OpenAILLMService(openai, logger, model, retryOptions) {
    ...
    OpenAILLMService.prototype.generateCompletion = function (prompt) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, promptLength, error_1, duration;
            var _this = this;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, retry_1.retryWithBackoff)(function () { return __awaiter(_this, void 0, void 0, function () {
                                var response, completion, duration;
                                var _this = this;
                                var _a, _b, _c;
                                return __generator(this, function (_d) {
                                    switch (_d.label) {
                                        case 0: return [4 /*yield*/, this.circuitBreaker.execute(function () {
                                                return _this.openai.chat.completions.create({
                                                    model: _this.model,
                                        ...
                                        case 1:
                                            ...
                                            this.logger.debug('Completion generated successfully', {
                                                ...
                                                promptTokens: (_a = response.usage) === null || _a === void 0 ? void 0 : _a.prompt_tokens,
                                                completionTokens: (_b = response.usage) === null || _b === void 0 ? void 0 : _b.completion_tokens,
                                                totalTokens: (_c = response.usage) === null || _c === void 0 ? void 0 : _c.total_tokens,
                    ...
                    case 3:
                        error_1 = _a.sent();
                        duration = Date.now() - startTime;
                        this.logger.error('Failed to generate completion', error_1, {
                            model: this.model,
                            promptLength: promptLength,
                            durationMs: duration
                        });
