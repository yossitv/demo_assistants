...
- [ ] 1. Create custom Lambda authorizer
  - [ ] 1.1 Implement authorizer handler function
  ...
  - [ ]* 1.2 Write property test for Authorization header extraction
    - **Property 1: Authorization header extraction**
    - **Validates: Requirements 1.1, 1.2, 5.1**

  - [ ]* 1.3 Write property test for no prefix requirement
    - **Property 2: No prefix required**
    - **Validates: Requirements 1.4**

  - [ ]* 1.4 Write property test for x-api-key fallback
    - **Property 3: Backward compatibility with x-api-key**
    - **Validates: Requirements 1.5**

  - [ ]* 1.5 Write property test for usageIdentifierKey correctness
    - **Property 4: UsageIdentifierKey matches extracted key**
    - **Validates: Requirements 3.2, 5.2**

  - [ ]* 1.6 Write property test for fixed principal ID
    - **Property 5: Fixed principal ID**
    - **Validates: Requirements 5.3**

  - [ ] 1.7 Implement secure logging
  ...
  - [ ]* 1.8 Write property test for API key not logged
    - **Property 6: API key not logged**
    - **Validates: Requirements 4.1**

  - [ ]* 1.9 Write property test for request ID logged
    - **Property 7: Request ID logged**
    - **Validates: Requirements 4.2**

  - [ ]* 1.10 Write property test for header presence logged
    - **Property 8: Header presence logged**
    - **Validates: Requirements 4.3**

  - [ ]* 1.11 Write unit tests for error cases
...
- [ ] 2. Update CDK stack for custom authorizer
  - [ ] 2.1 Create authorizer Lambda function resource
  ...
  - [ ] 2.2 Create IAM role for authorizer
  ...
  - [ ] 2.3 Create API Gateway custom authorizer
    - Create RequestAuthorizer with authorizer Lambda
    - Set identitySources to both Authorization and x-api-key headers
    - Set resultsCacheTtl to 0 (disable caching for MVP)
    - _Requirements: 1.1, 1.5_

  - [ ] 2.4 Configure API Gateway with AUTHORIZER source
  ...
  - [ ] 2.5 Update all endpoint method configurations
    ...
    - Keep apiKeyRequired: true for all endpoints
...
- [ ] 4. Deploy and verify
  - [ ] 4.1 Build and deploy CDK stack
  ...
  - [ ]* 4.2 Verify CDK configuration
    - Check synthesized CloudFormation template for apiKeySourceType
    - Verify all endpoints use custom authorizer
    - Verify authorizer Lambda has CloudWatch Logs permissions
    - _Requirements: 3.1, 6.1, 6.2, 6.3, 6.4, 7.1, 7.2_

  - [ ]* 4.3 Manual testing with Authorization header
  ...
  - [ ]* 4.6 Verify API Gateway access logs
